...
// Ambil data dari tabel projects dan join ke users untuk ambil nama PM
$sql = "SELECT 
            p.id_project,
            p.kode_project, 
            p.nama_project, 
...
<body>
  ...
  <a href="monitor_reimbursement.php">Monitor Rembursement</a>
    ...
    <button class="btn" onclick="window.location.href='tambah_project_list.php'">
      ...
      <tbody>
        <?php if ($result && $result->num_rows > 0): ?>
          <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
              <td>
                <a href="ubah_project_list.php?id=<?= $row['id_project'] ?>"><i class="fas fa-pen icon" title="Edit"></i></a>
                <a href="hapus_project_list.php?id=<?= $row['id_project'] ?>" onclick="return confirm('Yakin ingin menghapus project ini?');"><i class="fas fa-trash icon" title="Hapus"></i></a>
              </td>
