...
// Tambahkan user_id login sebagai parameter pertama
$params = [$user_id];
$types = "i";

// Tambahkan filter-filter lain (opsional)
if ($filterNama !== "") {
...
while ($row = $result->fetch_assoc()) {
    ...
    $tanggal = $row['tanggal_pengajuan'] ?? null;
echo "<td>" . ($tanggal ? date('d-m-Y H:i', strtotime($tanggal)) : '-') . "</td>";
    echo "</tr>";
}
