...
LEFT JOIN log_pengajuan l ON l.id_pengajuan = p.id_pengajuan -- ✅ Perbaikan JOIN
LEFT JOIN aktifitas a ON l.id_aktifitas = a.id_aktifitas
WHERE l.id_aktifitas = 2
...
<br>
  ...
  <tbody>
    ...
    <tr>
<td>
  <a href="persetujuan_pm.php?id=<?= $row['id_pengajuan'] ?>" class="btn" style="padding: 6px 12px; font-size: 13px;">Proses</a>
</td>
